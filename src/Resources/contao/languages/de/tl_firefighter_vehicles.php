...
// Operations
$GLOBALS['TL_LANG']['tl_firefighter_vehicles']['edit']    = ['Fahrzeug bearbeiten', 'Fahrzeug ID %s bearbeiten'];
$GLOBALS['TL_LANG']['tl_firefighter_vehicles']['copy']    = ['Fahrzeug kopieren', 'Fahrzeug ID %s kopieren'];
$GLOBALS['TL_LANG']['tl_firefighter_vehicles']['delete']  = ['Fahrzeug löschen', 'Fahrzeug ID %s löschen'];
