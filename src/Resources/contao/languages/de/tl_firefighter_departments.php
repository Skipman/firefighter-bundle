...
$GLOBALS['TL_LANG']['tl_firefighter_departments']['edit'] = ['Bearbeite Feuerwehr ID %s', 'Bearbeite Feuerwehr ID %s'];
$GLOBALS['TL_LANG']['tl_firefighter_departments']['copy'] = ['Feuerwehr kopieren', 'Feuerwehr ID %s kopieren'];
$GLOBALS['TL_LANG']['tl_firefighter_departments']['new'] = ['Neue Feuerwehr anlegen', 'Legt eine neue Feuerwehr an'];
$GLOBALS['TL_LANG']['tl_firefighter_departments']['show'] = ['Feuerwehr anzeigen', 'Details der Feuerwehr ID %s anzeigen'];

// Legends
$GLOBALS['TL_LANG']['tl_firefighter_departments']['department_legend'] = 'Feuerwehr';
$GLOBALS['TL_LANG']['tl_firefighter_departments']['social_legend'] = 'Soziale Kanäle';
