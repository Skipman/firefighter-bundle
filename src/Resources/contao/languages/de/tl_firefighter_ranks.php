...
// Operations
$GLOBALS['TL_LANG']['tl_firefighter_ranks']['edit'] = ['Dienstrang bearbeiten', 'Dienstrang ID %s bearbeiten'];
$GLOBALS['TL_LANG']['tl_firefighter_ranks']['copy'] = ['Dienstrang kopieren', 'Dienstrang ID %s kopieren'];
$GLOBALS['TL_LANG']['tl_firefighter_ranks']['delete'] = ['Dienstrang löschen', 'Dienstrang ID %s löschen'];
